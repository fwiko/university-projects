...
public class Initiator {
    ...
    public static void main(String[] args) {
        ...
        if (args.length < 3) {
            System.err.println("Usage: java initiator <port_number> <load_balancer_ip_address> <load_balancer_port_number>");
            System.exit(-1);
        }
        ...
        try {
            ...
            System.err.println("Initiator - ERROR: The \"load_balancer_ip_address\" argument must be a valid IP Address");
            System.exit(-1);
        }
        ...
        try {
            ...
            System.err.println("Initiator - ERROR: The \"load_balancer_port_number\" argument must be a valid Integer");
            System.exit(-1);
        }
        
        // Get the IP Address of the Initiator as an InetAddress object
