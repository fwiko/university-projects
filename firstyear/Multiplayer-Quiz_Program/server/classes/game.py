...
class Game:
    ...
    def start_quiz(self) -> None:
        ...
        scores_table = {
            p.uid: {"score": 0, "username": p.username} for p in self.settings.players
        }
    ...
    def end_quiz(self) -> None:
        ...
        self._send_data(
            ...
            dict(
                sorted(
                    self.__current_quiz.scores.items(),
    ...
    def _quiz_sequence(self) -> None:
        ...
        self.alert(
            f"Quiz starting in 5 seconds! TOPIC: {self.__current_quiz.questions.get('topic').capitalize()}"
        )
        # wait 5 seconds
        time.sleep(5)
        ...
        for num, (q, a) in enumerate(self.__current_quiz.questions.get("questions")):
            ...
            while len(self.__current_quiz.current_question.get("submitted")) != len(
