...
class Client:
    ...
    def _recieve_file(
        ...
        while True:
            ...
            buffer = self._conn.recv(buffer_size)
        ...
        with open(os.path.join(save_dir, file_name), "wb") as file:
            ...
            print(utility.padded(f"{file_type} has been saved to {save_dir}"))
    ...
    def execute(self, cmd: str, *args) -> None:
        ...
        func = getattr(self, f"_{cmd}", None) if cmd in self._manager.keys() else None
