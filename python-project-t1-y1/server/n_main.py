...
class Client:
    ...
    def __process_command(self, command):
        # formatting the command, removing spaces, separating command and passed in arguments
    ...
    def listen(self):
        ...
        while self.__alive:
            try:
                ...
                if not data.get("header", None) or not data.get("data", None) or not data["data"].get("command"):
                    continue
                if data["header"] == "command":
                    self.__process_command(data["data"]["command"])
                elif data["header"] == "answer":
                    pass
